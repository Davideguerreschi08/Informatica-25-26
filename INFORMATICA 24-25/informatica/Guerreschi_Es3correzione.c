...
/* Esercizio: DATA UNA COPPIA DI NUMERI INTERI COSTRUIRE UN MENÙ TALE CHE
PREVEDA:
...
# include <stdlib.h>
	...
	int main(){
		int n1;
		int n2;
		int scelta, somma, k, scarto1, scarto2;
		srand (time(NULL));

		printf("-------MENU'--------\n");
		printf("1. ESEGUI LA SOMMA IN VALORE ASSOLUTO\n");
		printf("2. ESEGUI LA DIFFERENZA TRA MAGGIORE E MINORE\n");
