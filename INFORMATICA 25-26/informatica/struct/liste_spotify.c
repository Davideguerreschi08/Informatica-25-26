...
int main(){
    ...
    do{
        printf("\n===== SPOTIFY 0.0.0.1 =====\n");
        printf("1. Inserisci nuova canzone nella playlist\n");
...
void ricerca_canzone_artista(Lista* l, char artista){
    ...
    if(trovata==0){
        printf("Non esiste nessuna canzone di quest'artista \n");
    }
}
...
void cancella_canzone_playlist(Lista *playlist){
    int id;
    printf("Inserisci l'id della canzone da eliminare dalla playlist: ");
    scanf("%d", &id);
    getchar();
